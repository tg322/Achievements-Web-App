...
function SingleHouse(props:SingleHouseProps){
    ...
    const houseName = graphState.GraphSettings.dataType.type === 'house'? graphState.GraphSettings.dataType.house : ''
    ...
    return(
        ...
        <div style={{display:'flex', flexDirection:'column', backgroundColor:`rgba(${singleHouse.houseColor?.r}, ${singleHouse.houseColor?.g}, ${singleHouse.houseColor?.b}, 0.6)`, zIndex:'4', padding:'30px 0px 20px 0px'}}>
            ...
            <h1 style={{fontSize:'100px', margin:'0px', textAlign:'center', fontFamily: '"Bebas Neue", sans-serif', fontWeight:'600', letterSpacing:'12px'}}>{houseName.toUpperCase()}</h1>
        </div>
