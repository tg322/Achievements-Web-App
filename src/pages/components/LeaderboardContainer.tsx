        ...
        return(
            <div id='container' style={{display:'flex', flexDirection:'row', width:'100%', height:'100vh'}}>
                <div id='imagesContainer' style={{display:'flex', flexDirection:'column', width:'60%', height:'100%', position:'relative'}}>
                    {graphState.GraphSettings.dataType.type === 'student_year' && <h1 style={{position:'absolute', top:'calc(50% - 133px)', left:'calc(50% - 270px)', margin:'0px', fontSize:'100px', textAlign:'center', width:'540px', transform: 'rotate(350deg)', fontFamily: '"Courgette", cursive', textShadow:'-1px 2px black', color:'white'}}>
