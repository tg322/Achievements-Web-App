...
const initialState: GraphState = { GraphSettings: {type:'house', dataType:null, orientation:null, interval:30000, data:[]}};
...
//Switch statement for actions and their... actions?
    switch (action.type) {
        ...
        case 'CLEAR_GRAPH_STATE':
          return { ...graphState, GraphSettings: {type:'house', dataType:null, orientation:null, interval:30000, data:[]}};
        default:
            return graphState;
    }
};
